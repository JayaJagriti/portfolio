        ...
        <div className="card frame ovCard">
          <div className="ovLabel">Highlights</div>
            ...
            <div className="card ovInner">
             <div style={{ fontWeight: 700 }}>AI Knowledge Agent</div>
             <p className="p">RAG-based AI agent + LangGraph workflows + PDF Q&A + Groq API + AWS + Streamlit</p>
</div>
          ...
          <div className="ovStack">
            ...
            <div className="card ovInner">
              ...
              <p className="p">RAG • LangGraph • React • Django/DRF • AWS • Groq API • LangChain</p>
            </div>
          </div>
        </div>
        ...
        <div className="card frame ovCard">
          ...
          <div className="ovStack" style={{ marginTop: 14 }}>
            ...
            >
              ...
              <p className="p">www.linkedin.com/in/jaya-jagriti</p>
            </a>
