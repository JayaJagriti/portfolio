    ...
    <SectionWrap id="projects" title="Projects">
      <div className="projectsGrid">
        ...
        <ProjectCard
          ...
          bullets={[
            "Built using LangGraph + Groq LLM to create a stateful AI agent capable of multi-step reasoning, tool usage, and dynamic decision workflows.",
            "Deployed on AWS with RAG-based architecture (PDF ingestion + semantic retrieval), enabling fast, context-aware responses across PixelNerve’s internal knowledge base."
          ]}
          tags={["Python", "LangGraph", "RAG", "Groq API", "AWS", "HuggingFace"]}
        />
        <ProjectCard
          title="MedGenie 3.0"
